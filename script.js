...
window.addEventListener('DOMContentLoaded', (e) => {
    document.getElementById("img-container").style.backgroundImage="url('icons/houston.jpeg')"
...
async function initMap(){
    autocomplete = await new  google.maps.places.Autocomplete(locationInput, 
    {
    ...
    autocomplete.addListener('place_changed', () => {
        ...
        imageUrl = location.photos[0].getUrl()
...
function updateImage(imageUrl){
    document.getElementById("img-container").style.backgroundImage=`url(${imageUrl})`
}
